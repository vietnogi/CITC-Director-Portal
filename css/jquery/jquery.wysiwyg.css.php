...
div.wysiwyg { border: 1px solid #999; padding: 5px; background: #fff url("../images/jquery/jquery.wysiwyg.bg.png") repeat-x top; }
...
div.wysiwyg ul.toolbar li { text-indent: -5000px; opacity: 0.85; filter: alpha(opacity=85); display: block; width: 16px; height: 16px; background: url('../images/jquery/jquery.wysiwyg.gif') no-repeat -64px -80px; border: 1px dotted rgb(240, 240, 240); cursor: pointer; margin: 0px; }
