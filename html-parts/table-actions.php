<div class="table-actions">
	...
	<ul class="global buttons">
		<li class="export csv"><a href="<?= $this->url('/ajax' . $GLOBALS['bc']->path . '/csv') ?>&amp;<?= $_SERVER['QUERY_STRING'] ?>" title="Export entire list (all pages) to CSV/Excel">Export All to CSV</a></li>
